-- AIPIWEN V3a Preview registration RPC recursion fix.
--
-- Migration 015 added the practitioner_type_note signature but routed the new
-- implementation through the 8-argument compatibility function. This migration
-- makes the 9-argument function the full authoritative implementation and keeps
-- the 8-argument function as a wrapper only.
