-- AIPIWEN V3a Preview registration option taxonomy.
--
-- Keeps the existing authorization roles, while expanding the user-facing
-- application identity and practitioner type choices used by the registration
-- form.
...
comment on function public.v3a_submit_pending_application(
  ...
  'Creates one pending users/profile/application set atomically from the current verified Supabase Auth identity; accepts current V3a registration option taxonomy.';
