...
;(function (root, factory) {
  ...
  // ── 纹型符号 → 主类型标签 ──────────────────────────────────────────
  const LBL = {
    'Ws':'认知', 'Wt':'认知', 'We':'认知', 'Wsp':'认知',   // 螺旋/靶心/伸长/侧袋斗
    'Wc':'整合', 'Wd':'整合', 'Wsc':'整合',                 // 双斗上下/左右/双箕斗
    'Wpe':'完美','Rpe':'完美','Wl':'完美', 'Rwl':'完美',    // 孔雀眼/反孔雀/侧向/反侧向斗
    'Lu':'模仿', 'Ls':'模仿', 'Lf':'模仿',                  // 正箕类
    'Rl':'反箕',                                             // 反箕(触发逆思)
    'X':'开放',  'Xn':'开放',                               // 简单弧/帐篷弧
  };
  ...
  const REVERSE  = new Set(['Rl','Rpe','Rwl']);          // 具有逆向思维的纹型
  ...
  return { classify, classifyMain, LBL, TYPE2KEY, _typeKey };
});
