...
(function (root, factory) {
  ...
  const TRC_TYPE_MAP = {
    ...
    combo_w: {
      ...
      standard_name:    '多维认知型',
      display_name:     '多维认知型',       // 修正：原 classify() 输出动态字符串
      poster_name:      '双重天赋型孩子',
      ai_prompt_name:   '多维认知型',
      consultant_name:  '双重天赋型',
    ...
    combo_w_l: {
      ...
      standard_name:    '认知模仿双驱型',
      display_name:     '认知模仿双驱型',   // 修正：原 classify() 输出动态字符串
      poster_name:      '主见学习型孩子',
      ai_prompt_name:   '认知模仿双驱型',
      consultant_name:  '主见学习双驱型',
    ...
    combo_open: {
      ...
      standard_name:    '开放加持型',
      display_name:     '开放加持型',       // 修正：原 classify() 输出动态字符串
      poster_name:      '开放加持型孩子',
      ai_prompt_name:   '开放加持型',
      consultant_name:  '开放融合型',
      tagline:          '主导加持 · 开放吸收 · 成长灵活 · 多元适应',
      legacy_aliases:   [],
      kb_exists:        false,              // ⚠️ 知识库缺失——需补充条目
      needs_review:     true,
    },
