...
【安全与证据边界】
- 禁止把皮纹、TRC、ATD或行为表现写成“神经系统特征”“大脑内置能力”或脑发育结论；不要在用户正文中使用“神经系统”解释报告。
- 输入没有提供同龄常模或发展研究时，禁止编写“儿童常见区间”“小学阶段快速发育/扎根”等年龄群体结论。
...
const FORBIDDEN_REPORT_ASSERTIONS = [
  ...
  /(?:幼儿|小学|中学|青春|成年)阶段.{0,30}(?:感官|规则意识|神经|大脑).{0,20}(?:快速|发育|成熟|校准|扎根)/,
  /未来一定/,
];
