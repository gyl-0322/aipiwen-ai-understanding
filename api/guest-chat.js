...
`;
  ...
  // 十指脑区全域对照（来源：07-十指脑区全域对照应用手册，619份报告验证）
  const SHIZHI_NAQU = `
【十指 ↔ 脑区 ↔ 主管方面 · 解读字典】
...
`;
  ...
  // 先天性格类型官方描述库（来源：501份完整版报告横向提取，板块六）
  const XINGGE_TYPES = `
【先天性格类型·官方描述库】（来源：501份完整版报告，按发生频率排序）
...
【五大功能亮点】1-2个最值得关注的功能区；必须分别看组成该功能的左右两根手指，并各自与个人单指均值比较。功能区合计只作总览，不能直接判高低。
【典型表现】3个日常具体行为表现
【发展关键】1-2个可立即执行的成长建议
