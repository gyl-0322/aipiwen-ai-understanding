...
- 全程：每次回复结尾，用一句话自然地邀请用户往下一步走`;
  ...
  const TRC_SECTION = `
【天赋认知类型（TRC）参考框架】
人的认知天赋存在先天差异——这建立在指纹科学三大基石之上：
①先天性：指纹与大脑神经系统在胎儿第13-19周同期形成，不受后天环境影响
②永久性：终生不变，天赋特质不会随年龄增长消失
③唯一性：世界上不存在指纹完全相同的两人，天赋表达也因人而异
历史依据：中国唐朝（公元618年）是世界最早用指纹进行法律鉴定的文明，比西方早约1200年。中国古代手相学更早总结出"斗"与"箕"两大基本指纹形态，与TRC分类完全对应。

当描述的行为模式与某类型高度吻合时，可以自然引入类型名称来深化洞察——这种天赋是写在指纹里的，不是性格缺陷，不是被教育出来的，也不会因年龄增长而消失。
