...
const ContentLibrary = {
  ...
  DB: {
    ...
    emotional_explosion: {
      ...
      body: '孩子激烈的情绪反应，不是"无理取闹"，而是一个过载信号。情绪调节能力是大脑前额叶负责的——而前额叶在25岁才发育完全。孩子现在的爆发，是他用目前有限的神经资源在应对一个超过承载上限的时刻。记住一句话：情绪下不来，认知进不去。',
      insight_tpl: '你看到的是「${keyPhrase}」，但孩子在说：我现在的感受超过我能承受的了，我需要你帮我，而不是要求我立刻停下来。',
      struct_heading: '情绪爆发是一个"超载"现象，不是态度问题',
      struct_body: '你描述的「${keyPhrase}」，呈现的是「情绪触发 → 感受积累 → 超过承载 → 外化表现」这个完整过程。某个具体的触发点（催促、比较、被否定）引发了强烈感受，而孩子还没有足够的工具来调节，所以"爆炸"了。这不是道德问题，是神经发育阶段的正常挑战。\n\n科学依据：人的情绪脑每秒处理1100万条信息，理性脑只有40条——当情绪激活，道理根本进不去。这是神经生理限制，不是孩子的态度问题。',
      misconceptions: [
        { wrong: '他是故意激怒我的', right: '孩子情绪爆发时，前额叶几乎关闭——他没有能力"故意"，他只是被情绪淹没了' },
        { wrong: '太脆弱了，要锻炼抗压', right: '情绪敏感是特质不是弱点；强制压制不会让他更坚强，反而会让情绪调节更难' },
        { wrong: '趁现在讲道理印象深刻', right: '情绪激活时大脑无法接收任何信息——"趁热"讲道理会让他更抗拒，等冷却后再谈' }
      ],
      advice: [
        {
          tag: '第一步：先处理情绪',
          text: '情绪爆发期间停止输出任何信息。用情绪命名代替评判：说出你观察到的孩子的感受，不评判行为。情绪被命名后，神经系统会快速切换。',
          example: '"你现在一定很不好受。我在这里。"（不是"你不能这样！"）'
        },
        {
          tag: '第二步：等冷却再沟通',
          text: '等情绪平复后（通常15–30分钟）再处理事情。用"是-受-求"三步说话：说事实（是）→说感受（受）→说请求（求），全程用"我"开头。',
          example: '"我看到你刚才把东西摔了（是），我心里很难受（受），你能告诉我刚才发生了什么吗（求）？"'
        },
        {
          tag: '长期：减少触发点',
          text: '减少"催促-评判-比较"的语言密度。每减少一个触发点，就减少一次爆发的可能。也可以帮孩子建立情绪出口：跑步、画画、大声说出来——有出口，爆炸就少。',
          example: '把"你怎么还没做"换成"今天作业什么时候想开始？"'
        }
      ],
      share_summary: '你看到的是「${keyPhrase}」，但孩子在说：我现在的感受超过了我能承受的，我需要先被看见，再被引导。'
    },
    ...
    emotional_sensitive: {
      ...
      advice: [
        ...
        {
          tag: '怎么做',
          text: '帮他建立"情绪颗粒度"——不只说"生气"或"不好"，而是能区分：是委屈？挫败？被忽视？还是害怕？情绪颗粒度越高，孩子越能快速调节自己的情绪。一起练习命名具体的感受。',
          example: '平静时问："你今天有没有一刻感觉委屈的？委屈和难过有什么不一样？"'
        },
        {
          tag: '调整环境',
    ...
    homework_conflict: {
      ...
      body: '孩子对作业的抵触，表面是拖延或发脾气，背后往往是控制感的丧失。频繁催促本身就是压力来源——孩子越被催，情绪系统越紧张，越难进入专注状态。当孩子把"写作业"和"被强迫"画上等号，他抵抗的就不是作业本身，而是"被控制"的感觉。另一个常见原因：孩子还不具备某项学习技能（时间分配、任务拆解、专注切换），被催但缺乏技能，就变成了逃避。',
      insight_tpl: '「${keyPhrase}」的背后，孩子在说：我也想把作业做完，但我需要感觉这是我自己的决定，或者——我需要有人帮我找到方法，而不只是要求结果。',
    ...
    phone_addiction: {
      heading_tpl: '「${keyPhrase}」——游戏满足了现实里缺失的四件事',
      body: '孩子沉迷手机或游戏，背后是现实中四类需求没有被满足：① 及时成就感（做对就有奖励）② 丰富多彩的自由世界 ③ 创造性的自主空间 ④ 社交连接。游戏设计师专门针对这四点打造了"完美体验"——这不是意志力能对抗的，需要在现实中提供等价替代。',
      insight_tpl: '「${keyPhrase}」的背后，孩子不是在逃避你，他是在游戏里找到了一个给他及时反馈、让他有掌控感、不批评他的世界。',
      struct_heading: '沉迷屏幕是"现实四类满足不足"的信号，不是意志力问题',
      struct_body: '你描述的「${keyPhrase}」，背后是这个机制：现实中缺乏成就感/自由/自主权/社交满足 → 游戏精准填补这四类需求 → 大脑形成强烈的奖赏连接 → 任何打断都引发强烈抵抗。\n\n真正成瘾的判断标准（需符合5-6条才算）：①说谎掩盖游戏时间 ②花越来越多时间才满足 ③减少时烦躁不安 ④用游戏逃避现实问题 ⑤不完成日常任务 ⑥偷玩偷充值。只是喜欢玩游戏，不等于成瘾。',
      misconceptions: [
        { wrong: '他就是懒，整天玩手机', right: '他在游戏里得到了及时的成就感和自主权——说明他有这些需求，只是出口放错了地方' },
        { wrong: '把手机没收就好了', right: '没收手机只是切断出口，四类现实需求还在；孩子会用更强烈的方式求得满足' },
        { wrong: '把游戏当奖励，做完作业才能玩', right: '这样做反而人为提高了游戏的吸引力，贬低了学习——快乐只能被快乐替代，不能被惩罚替代' }
      ],
      advice: [
        {
          tag: '不要对立化',
          text: '不要把游戏和学习对立（"完成作业才能玩"）。这会让孩子的大脑把学习当成游戏的敌人。游戏是正常活动，学习也是正常活动，谁都不是对方的奖励。',
          example: '把规则改成固定时间段：晚上7-8点是学习时间，8-8:30是自由时间（包括游戏）——时间固定，不依赖于完成情况。'
        },
        {
          tag: '协商+给主控权',
          text: '让孩子参与制定规则，并拥有"主控权"。他自己制定的规则，他更愿意遵守。给出底线，让他决定细节。随着他能证明自己可以管理，逐步扩大他的权限。',
          example: '"游戏时间我的底线是每天不超过1.5小时，具体放在哪个时间段、玩什么游戏你来决定。"'
        },
        {
          tag: '在现实中提供替代满足',
          text: '在现实中建立四类替代体验：成就感（发现孩子进步立刻具体表扬）、自主空间（80%的事不纠错，让他做主）、创造性活动（乐高/运动/烹饪）、社交连接（支持朋友往来）。替代足够了，游戏的吸引力自然下降。',
          example: '每周和孩子做一件他选定的事，认真参与，不讲道理——这是现实中最强的成就感和连接。'
        }
      ],
      share_summary: '你看到的是「${keyPhrase}」，但孩子在说：我在游戏里找到了现实里缺少的及时认可、自主权和成就感。'
    },

    withdrawal: {
      heading_tpl: '「${keyPhrase}」——沉默有三种含义，只有一种是冷漠',
      body: '孩子的沉默有三种来源：① 武器型沉默（主动用不说话表达不满）② 无奈型沉默（不知道怎么说，或怕说了更糟）③ 自我保护型沉默（内部超载，需要关闭来喘息）。大多数孩子的沉默属于②或③，不是故意冷漠，而是承载能力已经到极限。追问只会加剧②③——他们需要的是感到安全，才能开口。',
      insight_tpl: '「${keyPhrase}」不是冷漠，而是在说：我现在没有能力处理更多了，或者我还不知道怎么说——我需要一个安全的空间，不是更多压力。',
      struct_heading: '沉默是孩子的自我保护，不是对你的惩罚',
      struct_body: '你描述的「${keyPhrase}」，背后是孩子的保护系统在运作。人在超载时有两种原始反应：攻击（fight）或回避（flight）。选择沉默，说明孩子在管理一种还不知道如何面对的压力——这需要安全感，不是追问。\n\n关键区分：接纳他现在不说话的状态（接纳）≠ 认可沉默是解决问题的正确方式（认可）。你可以接纳他现在沉默，同时在他准备好时帮他学会表达。',
      misconceptions: [
        { wrong: '他在故意用沉默惩罚我', right: '只有武器型沉默才是主动的；大多数孩子沉默是因为不知道怎么说或已经超载' },
        { wrong: '追问一定能让他开口', right: '追问在他关闭状态下只会让他更封闭——他的安全感越低，门关得越紧' },
        { wrong: '不说话就是没事，不用管', right: '越沉默的孩子往往内心撑得越久；安静不等于没有困难，只是出口堵住了' }
      ],
      advice: [
        {
          tag: '共情三步：反思→描述→承认',
          text: '停下追问的冲动（反思）→ 说出你观察到的事实（描述）→ 承认他的感受是真实的（承认）。不需要他回应，感受被承认本身就会打开一点空间。',
          example: '"我看到你把自己关在房间里（描述），我猜今天一定发生了什么不好受的事（承认）。我在外面，不催你，你准备好了随时来找我。"'
        },
        {
          tag: '并肩而非面对面',
          text: '建立"并肩时光"：不谈正事，只是在一起做轻松的事。孩子通常在没有压力的侧面活动中更容易开口——不是被盯着问，而是在走路或做事时自然说出来。',
          example: '一起散步、做饭、看他喜欢的节目——不提学习、不谈冲突，就只是在一起。'
        },
        {
          tag: '长期：帮他建立表达出口',
          text: '孩子沉默往往是因为不知道怎么表达（技能缺口）。帮他发展情绪词汇：平静时一起练习命名感受，建立"感受词汇表"。表达能力强了，沉默自然减少。',
          example: '平静时问："你今天有没有一刻觉得……委屈的？无聊的？开心的？"不用评价，只是帮他练习命名。'
        }
      ],
      share_summary: '你看到的是「${keyPhrase}」，但孩子在说：我现在的状态还不能处理更多——我需要先感到安全，然后才能开口。'
    },

    aggression: {
      heading_tpl: '「${keyPhrase}」——打人说明孩子缺少一项技能，不是缺少品德',
      body: '孩子的攻击行为，不论是打人、踢人还是破坏物品，背后是两件事同时发生：① 有一种强烈情绪需要出口（愤怒、挫败、委屈、嫉妒） ② 还没学会用语言或其他方式表达这种情绪。他用身体说了一件他还不知道怎么用语言说的事。惩罚切断了出口，但没有给他新的出口。',
      insight_tpl: '「${keyPhrase}」背后，孩子不是坏，他是在用身体表达一件超出他语言能力的事——他需要学会一项技能，而不只是被制止。',
      struct_heading: '攻击行为 = 强烈情绪 × 技能缺口，不是道德问题',
      struct_body: '你描述的「${keyPhrase}」，背后是两个层次：有强烈情绪需要释放（愤怒、挫败、委屈、嫉妒），同时缺少合适的情绪表达技能。攻击是他在这两个条件叠加下的"自然"选择，而不是道德选择。\n\n技能法视角：问题不是"孩子为什么打人"，而是"如果孩子学会了什么技能，打人的行为会消失？"答案通常是：情绪命名技能 + 情绪表达出口技能。给他这两项技能，比只惩罚攻击行为更有效。',
      misconceptions: [
        { wrong: '他天生有攻击性，改不了', right: '攻击是技能缺口的表现——给他正确的技能和出口，攻击行为会自然减少' },
        { wrong: '打回去让他知道疼', right: '用攻击回应攻击，会教会孩子"强者可以用武力解决问题"——这是示范，不是教训' },
        { wrong: '严厉惩罚就能解决', right: '惩罚可以短期压制行为，但压不住情绪——情绪还在，还是会找其他出口爆发' }
      ],
      advice: [
        {
          tag: '事后：用感受代替评判',
          text: '等他完全平静后，讨论"感受"而不是"行为"。用共情三步：描述你看到的 → 承认他的感受 → 然后谈行为规则。感受被承认后，孩子才能听进去规则。',
          example: '"你刚才打了弟弟（描述）。我猜你当时一定很生气或很委屈（承认）。打人是不可以的，但你生气是可以的——我们来说说，下次你那么生气的时候可以怎么做？"'
        },
        {
          tag: '提前：给他一套情绪出口',
          text: '在平静时和孩子一起设计"发火清单"——列出他可以做的情绪出口：用力踩地板、抱枕头打、大声跑圈、说出来"我很生气"。让孩子自己选择，他更愿意用。',
          example: '"我们来想一想，你下次特别生气又不想打人，可以做什么？你说，我来记。"'
        },
        {
          tag: '长期：搭台阶，培养情绪技能',
          text: '帮孩子练习情绪命名——知道自己在生气、委屈还是受惊吓，是不攻击的第一步。从日常小事开始，不在冲突时教，在平静时练。找到规律性触发情境，针对性减少一个触发点。',
          example: '记录一周攻击发生的时间/情境/之前发生了什么——规律会告诉你真正的触发源。'
        }
      ],
      share_summary: '你看到的是「${keyPhrase}」，但孩子在说：我有一种强烈的感受找不到出口，我需要有人教我用别的方式表达它。'
    },
...
/* ================================================================
   天赋认知类型（TRC）知识库 — 17种类型解读卡片
   供 full-report.html、fingerprint 结果页等调用
================================================================ */
const TRCTypeLibrary = {
  ...
  DB: {
    认知型: {
      ...
      指纹溯源: '这种坚持独立推导的方式不是倔强，而是天生的认知运作方式——就像指纹从胎儿期就已写好、终生不变，认知型人的思维路径也有其内在的不可更改性。',
      color: '#4A90D9',
    },
    模仿型: {
      emoji: '🟢',
      ...
      总结: '模仿型人才一旦遇到真正值得学习的对象，便能以最快速度触及高度——是时代最优秀智慧的继承者。',
    ...
    开放型: {
      ...
      总结: '当开放型人才学会在开放中聚焦，便能成为融汇百家、推动跨界创新的桥梁人物。',
    ...
    逆思型: {
      ...
      总结: '当逆思型学会将逆向思维锻造成"创新之犁"，便能从令人头疼的"麻烦"蜕变为推动文明前进的最宝贵"稀缺资源"。',
    ...
    整合型: {
      ...
      总结: '整合型人才是最优秀的系统设计者——当他们找到能发挥全局视野的舞台，便能成为不可替代的"架构师"。',
    ...
    双视型: {
      ...
      总结: '当双视型学会在双视角中做出有力决断，便能成为化解对立、推动共识的关键人物。',
    ...
    超级认知型A: {
      ...
      总结: '当超级认知型A将掌控欲转化为责任感，便能从"颠覆性力量"蜕变为引领文明进步的"灯塔型领袖"。',
      指纹溯源: '1892年，高尔顿发表《指纹》，彻底重构了犯罪鉴定学的认知框架——这就是超级认知型A在历史上留下的印记：天生具备"把现有框架砸碎再重建"的神经驱动力，是文明跃升的发动机。',
      color: '#1ABC9C',
    },
    超级认知型B: {
      emoji: '💎',
      ...
      总结: '超级认知型B找到能承载其认知深度的领域和舞台时，能创造出改变行业认知的突破性成果。',
    ...
    超级认知型C: {
      ...
      总结: '当超级认知型C将强大的元认知能力转化为带领团队思考的力量，便能成为组织的"认知导航者"。',
      指纹溯源: '中国宋朝将指纹用于刑事诉讼，核心在于"如何判断指纹真假"的元层面思考——超级认知型C天生具备这种对"判断过程本身"的觉察力，能看见他人思维中看不见的漏洞。',
      color: '#0E6655',
    },
    超级模仿型: {
      emoji: '🌊',
      ...
      总结: '当超级模仿型在优质的环境中深根，便能成为凝聚集体智慧、打通不同圈层的关键枢纽。',
    ...
    弘拓模仿型: {
      ...
      总结: '弘拓模仿型先吸收最好的，再创造更好的——是推动各领域持续进化的核心力量。',
    ...
    弘拓整合开拓型: {
      emoji: '🌐',
      tagline: '跨界整合的创新先锋',
      核心天赋: '整合能力加开拓精神，天生的跨界创新者——善于将不同领域资源整合为全新方向。',
      ...
      总结: '当弘拓整合开拓型找到能发挥双重天赋的平台，便能创造颠覆性的新业态和新领域。',
    ...
    智业集道结型: {
      ...
      总结: '当智业集道结型将深厚专业积累转化为可传承的方法论，便能成为该领域真正的"宗师级"人物。',
      指纹溯源: '苏轼（1036-1101年）用一生积累，将分散的民间指纹知识系统化写入文集和政策建议——智业集道结型的历史写照：深耕一域，化经验为传世方法论。',
      color: '#2C3E50',
    },
    '智业集·开拓型': {
      emoji: '⚡',
      ...
      总结: '智业集·开拓型用专业深度保证可靠性，用开拓精神推动突破——是行业从"做好"到"做新"的关键驱动力。',
    ...
    '花茂美·逻辑型': {
      ...
      总结: '当花茂美·逻辑型将审美直觉与严密逻辑融合，便能创造出既有深度又有温度的作品与系统。',
      指纹溯源: '中国古代指画艺术将审美与逻辑完美统一——画家必须同时精确控制力道（逻辑）和意境（美感）。花茂美·逻辑型天生就在做这件事：用秩序创造美，用美感诠释秩序。',
      color: '#E91E63',
    },
    '花茂美·开拓型': {
      emoji: '🌸',
      ...
      总结: '当花茂美·开拓型的审美天赋与开拓精神找到合适的土壤，便能创造出让时代为之惊叹的美丽与突破。',
      指纹溯源: '中国指画艺术在唐宋发展到顶峰，名家们不满足于模仿前人，总在探索手指能创造的新意境——花茂美·开拓型在历史上的写照：用美去开拓从未有人踏足的领域。',
      color: '#AD1457',
    },
    超级整合开拓型: {
      emoji: '🌟',
      ...
      总结: '当超级整合开拓型遇到能承载其宏大愿景的使命与团队，便能成为推动文明跃升的"系统革命者"。',
      指纹溯源: '将指纹从公元前2200年巴比伦的"签名习俗"发展为现代全球刑侦标准体系，跨越5000年、20多国、数十个学科——这正是超级整合开拓型的历史级贡献：在最大尺度上整合人类知识，开创全新的文明基础设施。',
      color: '#F1C40F',
    },
  },
  ...
  /**
   * 获取类型卡片数据
   * @param {string} typeName - TRC类型名称
   * @returns {object|null}
   */
  get(typeName) {
    return this.DB[typeName] || null;
  },

  /**
   * 生成类型卡片HTML（供报告页面直接插入）
   * @param {string} typeName
   * @returns {string} HTML字符串
   */
  renderCard(typeName) {
    const d = this.get(typeName);
    if (!d) return '';
    return `
<div class="trc-type-card" style="background:white;border:1px solid #EAE7E2;border-radius:16px;padding:22px 20px;margin-bottom:16px;border-left:4px solid ${d.color};">
  ...
  <div style="background:#F5F3EE;border-radius:10px;padding:12px 14px;margin-bottom:14px;">
    ...
    ${d.典型表现.map(t => `<div style="font-size:13px;color:#4A4540;padding:3px 0;padding-left:14px;position:relative;">· ${t}</div>`).join('')}
  </div>
  ...
  <div style="margin-bottom:14px;">
    ...
    ${d.发展关键.map(k => `<div style="font-size:13px;color:#4A4540;padding:3px 0;padding-left:14px;position:relative;">✓ ${k}</div>`).join('')}
  </div>
  <div style="background:${d.color}15;border-radius:10px;padding:12px 14px;margin-bottom:14px;">
    <div style="font-size:13px;color:#4A4540;line-height:1.7;font-style:italic;">${d.总结}</div>
  </div>
  ${d.指纹溯源 ? `<div style="border-top:1px solid #EAE7E2;padding-top:12px;margin-top:2px;">
