...
|---|---|---|---|---|---|---|---|
| V3A Production V4 | `gyl-0322/aipiwen-ai-understanding` | `recovery/v4-production-sot-20260813` | Production source `4c1bc9106c086d440c8287e4968ef7dd2d788b95`; provenance commits `0821e834abba35acc93a89d09a6b3f1a729d2fd5`, `dba89c0b25c294e3d8f3f21fa66c3a9a39713aaa`; registry is hosted at current branch tip | Production | `tysbwijizgebnrazxpvo` | `dpl_4KnKteVky3rmwJzjeLX6hNaKLRnw` | `RECOVERED` |
...
| Family OS | `/Users/gyl0322gmail.com/Documents/AIPIWEN家庭成长服务经营系统` | `baseline/v3.1-family-os-20260813` | Initial source baseline `2645218c3d8f8d4b5fc4f4f0907d27c32e0f3834`; scan-reconciliation head `b05d92dfedb1714c4455dfb6014bff0b2e859cd8`; current tree `e2638c04e873de12a4f02024de2f851e7860bb82` | Local only | local development only | none | `BASELINED / REMOTE PENDING` |
